...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2020 at 06:11 AM
...
CREATE TABLE `journal_entry` (
  `id` int(10) NOT NULL,
  `journal_head` varchar(256) DEFAULT NULL,
  `debit` varchar(256) DEFAULT NULL,
...
INSERT INTO `journal_entry` (`id`, `journal_head`, `debit`, `credit`, `created_at`, `updated_at`) VALUES
(1, '5454', '55', '', '2020-12-14 06:08:08', NULL);
